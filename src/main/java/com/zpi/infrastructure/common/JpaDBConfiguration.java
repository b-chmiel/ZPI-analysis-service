...
public class JpaDBConfiguration {
    ...
    @Bean
    JpaUserIncidentsRepositoryImpl userIncidentsRepository(JpaUserIncidentsRepositoryImpl.JpaUserIncidentsRepo jpa) {
        return new JpaUserIncidentsRepositoryImpl(jpa);
    }
}
